...
export type GetCurrentMess = {
  ...
  MontlyPrices: Scalars['Int']['output'];
...
export type GetcurentMessdataQuery = { __typename?: 'Query', getproviderMessData?: { __typename?: 'GetCurrentMess', id: string, MontlyPrices: number, messVerified: boolean, createdAt: string, MessQrcode: string, identity: { __typename?: 'Identitys', name: string, startTime: string, endTime: string, dietaryType: string, operatingMode?: string | null }, legal: { __typename?: 'Legals', fssaiNumber: string }, media: { __typename?: 'Medias', cover: string, kitchen: string, dining: string }, location: { __typename?: 'Locations', address: string, houseNo: string, society: string, landmark: string, suburb?: string | null, city: string, state: string, postcode: string, lat: number, lng: number }, Menu?: Array<{ __typename?: 'menu', _id?: string | null, types?: string | null, imageUrl?: string | null, createdAt?: string | null } | null> | null, myAllSubscribers?: Array<{ __typename?: 'SubscriberforMess', id: string, price: number, totalDays: number, startAt?: string | null, lastScannedAt?: string | null, RemainingDay?: number | null, allScans?: Array<{ __typename?: 'subscannerlatest', scannedAt?: string | null } | null> | null, userId?: { __typename?: 'User', id: string, first_name: string, last_name: string, number?: string | null, emailId: string } | null } | null> | null } | null };
